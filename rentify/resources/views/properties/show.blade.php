          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Property N°: {{ $property->id }}</h4>
                    <div class="add-items d-flex">
                      {{-- <form method="get" action="{{url('/search')}}">
                       ...
                       <div class="container mt-4">
                        ...
                        <div>
                          <p class="card-description">City: </p> {{ $property->city }}
                        </div><br>
                        <div>
                          <p class="card-description">Description: </p>{{ $property->description }}
                        </div><br>
                        <div>
                          <p class="card-description">Monthly Cost:</p> {{ $property->monthlyCost }}
                        </div><br>
                        <div>
                          <p class="card-description">Property Type: </p>{{ $property->propertyType }}
                        </div><br>
                        <div>
                          <p class="card-description">Furnish Type:</p> {{ $property->furnishType }}
                        </div><br>
                        <div>
                          <p class="card-description">Let Type:</p> {{ $property->letType }}
                        </div><br>
                        <div>
                          <p class="card-description">Available from :</p> {{ $property->availability }}
                        </div><br>
                        <div>
