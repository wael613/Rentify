          ...
          <ul class="nav">
            ...
            <li class="nav-item sidebar-actions">
              <span class="nav-link">
                ...
                <button class="btn btn-block btn-lg btn-gradient-primary mt-4" type="button" href="{{ route('users.create') }}">+ Add new user</button>
                ...
                <div class="col-md-6 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample" method="post" action="{{ route('properties.update', $property->id) }}">
                        @method('patch')
                        @csrf
                        <div class="form-group">
                          <label for="exampleInputUsername1">Name</label>
                          <input value="{{ $property->name }}" name="name"   type="text" class="form-control" id="exampleInputUsername1" placeholder="Name" required>
                          @if ($errors->has('name'))
                      ...
                      @endif
                        ...
                        <div class="form-group">
                          ...
                          <input value="{{  $property->address}}" name="address" required type="text" class="form-control" id="exampleInputEmail1" placeholder="Email">
                      ...
                      @endif
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{  $property->city }}"  type="text" class="form-control" id="exampleInputUsername1" placeholder="Name" name="city" required>
                            @if ($errors->has('city'))
                        ...
                        @endif
                          ...
                          <div class="form-group">
                            ...
                            <input value="{{ $property->monthlyCost }}"  type="number" class="form-control" id="exampleInputUsername1" placeholder="Name" name="monthlyCost" required>
                        ...
                        <div class="form-group">
                            ...
                            <select name="furnishType" class="form-control" id="furnishType">
                                ...
                                <option value="furnished" {{($property->furnishType === 'furnished') ? 'Selected' : ''}}>Furnished</option>
                                <option value="unfurnished"  {{($property->furnishType === 'unfurnished') ? 'Selected' : ''}}>Unfurnished</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="letType" class="form-control" id="letType">
                                ...
                                <option value="longTerm" {{($property->letType === 'longTerm') ? 'Selected' : ''}}>Long Term</option>
                                <option value="shortTerm" {{($property->letType === 'shortTerm') ? 'Selected' : ''}}> Short Term</option>
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ $property->availability }}" 
                            type="date" 
                            class="form-control" 
                            name="availability" 
