                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            @endif
                              ...
                              <td><a href="{{ route('properties.show', $property->id) }}" class="btn btn-gradient-warning btn-sm">Show</a></td>
                                <td><a href="{{ route('properties.edit', $property->id) }}" class="btn btn-gradient-info btn-sm">Edit</a></td>
                                <td>
