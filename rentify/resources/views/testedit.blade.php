                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="add-items d-flex">
                        <input type="text" class="form-control todo-list-input" placeholder="search property">
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                {{-- <form action="/add-property">
                                    <button  type="submit" class="btn btn-transparent">Edit <i class="mdi mdi-home menu-icon"></i></button>
                                </form>
                                <form action="/add-property">
                                    <button  type="submit" class="btn btn-transparent">Edit <i class="mdi mdi-home menu-icon"></i></button>
                                </form> --}}
                                <div class="btn-group btn-group-sm" role="group" aria-label="...">
                                    <button type="button" class="btn btn-transparent"><i class="mdi mdi-tooltip-edit "></i></button>
                                    <button type="button" class="btn btn-transparent"><i class="mdi mdi-delete-forever"></i></button>
                                </div>
                            </td>
                          </tr>
                          <tr>
