                    ...
                    <div class="card-body">
                      ...
                      <form class="forms-sample" method="post" action="{{ route('roles.update', $role->id) }}">
                        ...
                        <div class="form-group">
                          ...
                          <input value="{{ $role->name}}" name="name"   type="text" class="form-control" id="exampleInputUsername1" placeholder="Name" required>
                          @if ($errors->has('name'))
                      ...
                      @endif
                        ...
                        <button href="{{ route('roles.index') }}" class="btn btn-light">Back</button>
                      </form>
                    </div>
                  </div>
                </div>
