                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td><a href="{{ route('roles.show', $role->id) }}" class="btn btn-gradient-warning btn-sm">Show</a></td>
                                <td><a href="{{ route('roles.edit', $role->id) }}" class="btn btn-gradient-info btn-sm">Edit</a></td>
                                <td>
