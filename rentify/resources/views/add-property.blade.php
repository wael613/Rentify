        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Fill the Form please</h4>
                    <form class="form-sample" method="post" enctype="multipart/form-data" action="{{url('/add-property')}}">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <input type="text" class="form-control " name="monthlyCost" />
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input class="form-control" placeholder="dd/mm/yyyy" type="date" name="availability" />
                            </div>
                          </div>
                        </div>
                      </div>
