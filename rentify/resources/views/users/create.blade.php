                    ...
                    <div class="card-body">
                      ...
                      @endif
                        ...
                        <div class="form-group">
                          ...
                          <input value="{{ old('email') }}" name="email" required type="email" class="form-control" id="exampleInputEmail1" placeholder="Email">
                          @if ($errors->has('email'))
                      ...
                      @endif
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ old('username') }}"  type="text" class="form-control" id="exampleInputUsername1" placeholder="Name" name="username" required>
                        ...
                        @endif
                          ...
                          <div class="form-group">
                            ...
                            <input value="{{ old('phone') }}"  type="number" class="form-control" id="exampleInputUsername1" placeholder="Name" name="phone" required>
                            @if ($errors->has('phone'))
