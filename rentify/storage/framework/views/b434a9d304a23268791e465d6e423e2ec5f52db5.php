                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample" method="post" action="<?php echo e(route('properties.update', $property->id)); ?>">
                        ...
                        <div class="form-group">
                          ...
                          <input value="<?php echo e($property->name); ?>" name="name"   type="text" class="form-control" id="exampleInputUsername1" placeholder="Name" required>
                      ...
                      <?php endif; ?>
                        ...
                        <div class="form-group">
                          ...
                          <input value="<?php echo e($property->address); ?>" name="address" required type="text" class="form-control" id="exampleInputEmail1" placeholder="Email">
                      ...
                      <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <input value="<?php echo e($property->city); ?>"  type="text" class="form-control" id="exampleInputUsername1" placeholder="Name" name="city" required>
                        ...
                        <?php endif; ?>
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="description"><?php echo e($property->description); ?></textarea>
                        ...
                        <?php endif; ?>
                          ...
                          <div class="form-group">
                            ...
                            <input value="<?php echo e($property->monthlyCost); ?>"  type="number" class="form-control" id="exampleInputUsername1" placeholder="Name" name="monthlyCost" required>
                        ...
                        <select name="propertyType" class="form-control" id="propertyType">
                            ...
                            <option value="house" <?php echo e(($property->propertyType === 'house') ? 'Selected' : ''); ?>>House</option>
                            <option value="flat" <?php echo e(($property->propertyType === 'flat') ? 'Selected' : ''); ?>>Flat</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="furnishType" class="form-control" id="furnishType">
                                ...
                                <option value="furnished" <?php echo e(($property->furnishType === 'furnished') ? 'Selected' : ''); ?>>Furnished</option>
                                <option value="unfurnished"  <?php echo e(($property->furnishType === 'unfurnished') ? 'Selected' : ''); ?>>Unfurnished</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="letType" class="form-control" id="letType">
                                ...
                                <option value="longTerm" <?php echo e(($property->letType === 'longTerm') ? 'Selected' : ''); ?>>Long Term</option>
                                <option value="shortTerm" <?php echo e(($property->letType === 'shortTerm') ? 'Selected' : ''); ?>> Short Term</option>
                        ...
                        <div class="form-group">
                            ...
                            <input value="<?php echo e($property->availability); ?>" 
                            type="date" 
                            class="form-control" 
                            name="availability" 
                        ...
                        <div class="form-group">
                            <label for="exampleInputUsername1">Bedrooms/label>
                                <input value="<?php echo e($property->rooms); ?>" 
                        type="number" 
                        class="form-control" 
                        name="rooms" required>
                    ...
                    <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <input value="<?php echo e($property->baths); ?>" 
                            type="number" 
                            class="form-control" 
                            name="baths" required>
                        ...
                        <button type="submit" class="btn btn-gradient-primary me-2">Update Property</button>
...
</html><?php /**PATH E:\school\L3DSI\Projet-Integration\projet-l3dsi\rentify\resources\views/properties/edit.blade.php ENDPATH**/ ?>