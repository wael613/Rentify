          ...
          <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Manage Properties here</h4>
                      <div class="add-items d-flex">
                        
                          
                          <form method="get" action="<?php echo e(route('properties.create')); ?>">
                      ...
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <?php if($property->user_id == auth()->id()): ?>
                            <tr>
                              <td>
                              ...
                              <td> 
                                  <?php echo e($property->updated_at->diffForHumans()); ?>
                            ...
                            <?php endif; ?>
                              ...
                              <td><a href="<?php echo e(route('properties.show', $property->id)); ?>" class="btn btn-gradient-warning btn-sm">Show</a></td>
                                <td><a href="<?php echo e(route('properties.edit', $property->id)); ?>" class="btn btn-gradient-info btn-sm">Edit</a></td>
                                <td>
...
</html><?php /**PATH E:\school\L3DSI\Projet-Integration\projet-l3dsi\rentify\resources\views/properties/index.blade.php ENDPATH**/ ?>