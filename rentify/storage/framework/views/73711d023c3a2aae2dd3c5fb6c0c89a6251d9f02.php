                    ...
                    <div class="card-body">
                      ...
                      <?php endif; ?>
                        ...
                        <div class="form-group">
                          ...
                          <input value="<?php echo e(old('email')); ?>" name="email" required type="email" class="form-control" id="exampleInputEmail1" placeholder="Email">
                      ...
                      <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <input value="<?php echo e(old('username')); ?>"  type="text" class="form-control" id="exampleInputUsername1" placeholder="Name" name="username" required>
                        ...
                        <?php endif; ?>
                          ...
                          <div class="form-group">
                            ...
                            <input value="<?php echo e(old('phone')); ?>"  type="number" class="form-control" id="exampleInputUsername1" placeholder="Name" name="phone" required>
                            <?php if($errors->has('phone')): ?>
                            <span class="text-danger text-left"><?php echo e($errors->first('phone')); ?></span>
                        <?php endif; ?>
                          </div>
                        
                        <button type="submit" class="btn btn-gradient-primary me-2">Save User</button>
...
</html><?php /**PATH E:\school\L3DSI\Projet-Integration\projet-l3dsi\rentify\resources\views/users/create.blade.php ENDPATH**/ ?>