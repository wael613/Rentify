                ...
                <div class="col-md-6 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <p class="card-description"> Change user info here</p>
                      <form class="forms-sample" method="post" action="<?php echo e(route('users.update', $user->id)); ?>">
                        <?php echo method_field('patch'); ?>
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                          <label for="exampleInputUsername1">Name</label>
                          <input value="<?php echo e($user->name); ?>" name="name"   type="text" class="form-control" id="exampleInputUsername1" placeholder="Name" required>
                      ...
                      <?php endif; ?>
                        ...
                        <div class="form-group">
                          ...
                          <input value="<?php echo e($user->email); ?>" name="email" required type="email" class="form-control" id="exampleInputEmail1" placeholder="Email">
                      ...
                      <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <input value="<?php echo e($user->username); ?>"  type="text" class="form-control" id="exampleInputUsername1" placeholder="Name" name="username" required>
                            <?php if($errors->has('username')): ?>
                            <span class="text-danger text-left"><?php echo e($errors->first('username')); ?></span>
                        <?php endif; ?>
                          </div>
                          <div class="form-group">
                            <label for="exampleInputUsername1">Phone Numbr</label>
                            <input value="<?php echo e($user->phone); ?>"  type="number" class="form-control" id="exampleInputUsername1" placeholder="Name" name="phone" required>
                        ...
                        <button href="<?php echo e(route('users.index')); ?>" class="btn btn-light">Back</button>
                      </form>
                    </div>
                  </div>
                </div>
...
</html><?php /**PATH E:\school\L3DSI\Projet-Integration\projet-l3dsi\rentify\resources\views/users/edit.blade.php ENDPATH**/ ?>