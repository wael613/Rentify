          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Property N°: <?php echo e($property->id); ?></h4>
                    <div class="add-items d-flex">
                       ...
                       <div class="container mt-4">
                        ...
                        <div>
                          <p class="card-description">City: </p> <?php echo e($property->city); ?>

                        </div><br>
                        <div>
                          <p class="card-description">Description: </p><?php echo e($property->description); ?>

                        </div><br>
                        <div>
                          <p class="card-description">Monthly Cost:</p> <?php echo e($property->monthlyCost); ?>

                        </div><br>
                        <div>
                          <p class="card-description">Property Type: </p><?php echo e($property->propertyType); ?>

                        </div><br>
                        <div>
                          <p class="card-description">Furnish Type:</p> <?php echo e($property->furnishType); ?>

                        </div><br>
                        <div>
                          <p class="card-description">Let Type:</p> <?php echo e($property->letType); ?>

                        </div><br>
                        <div>
                          <p class="card-description">Available from :</p> <?php echo e($property->availability); ?>

                        </div><br>
                        <div>
                          <p class="card-description">Bedrooms</p>
                          <?php echo e($property->rooms); ?> Bedrooms
                        </div><br>
                        <div>
...
</html><?php /**PATH E:\school\L3DSI\Projet-Integration\projet-l3dsi\rentify\resources\views/properties/show.blade.php ENDPATH**/ ?>